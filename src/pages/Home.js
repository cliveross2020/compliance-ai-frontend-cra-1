    ...
    <div className="home">
      ...
      <section className="hero">
        <div className="hero-left">
          ...
          {/* Short welcome line */}
          <p className="welcome">Welcome — let’s keep compliant decisions quick and clear.</p>
          ...
          <div className="hero-ctas">
            <Link to="/ask-cai" className="btn btn-primary">AskCAI</Link>
      ...
      <section className="roles">
        <div className="role-card">
          ...
          <div className="role-links">
            ...
            <Link to="/ask-cai" className="chip">AskCAI</Link>
          </div>
        </div>
      ...
      <section className="inside">
        ...
        <div className="inside-grid">
          <Link to="/ask-cai" className="inside-card">
            <h4>AskCAI</h4>
