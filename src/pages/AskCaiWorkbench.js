...
class PdfErrorBoundary extends React.Component {
  ...
  componentDidCatch(err, info) {
    // logs useful details to console in prod too
    ...
    if (this.state.hasError) {
      return (
        <div className="wb-pdf-error">
          <div>We couldn’t open the PDF. This is usually a network or CORS hiccup.</div>
...
export default function AskCaiWorkbench() {
  ...
  // Chat state (unchanged — trimmed for brevity)
              ...
              <Worker workerUrl="https://unpkg.com/pdfjs-dist@3.4.120/build/pdf.worker.min.js">
                <Viewer
                  ...
                  onDocumentLoadFail={(e) => {
                    ...
                    // force the error boundary on next render
                    throw e;
                  }}
                />
              </Worker>
