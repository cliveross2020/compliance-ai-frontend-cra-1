...
// Prefer ABPI 2024 when available
...
export default function AskCaiWorkbench() {
  ...
  const [usedClauses, setUsedClauses] = useState([]);
  ...
  return (
    <div className="workbench">
      {/* Left: full PDF viewer with toolbar + search */}
      <section className="wb-left">
        ...
        <div className="wb-viewer-wrap">
          <Worker workerUrl="https://unpkg.com/pdfjs-dist@3.4.120/build/pdf.worker.min.js">
            <Viewer fileUrl={proxiedUrl} plugins={[defaultLayout]} />
          </Worker>
        </div>

        <div className="wb-hint">
          Tip: use the toolbar’s <strong>Search</strong> to find inside the PDF.
        </div>
      </section>
