...
export default function AskCaiWorkbench() {
  ...
  // Prefer PDF.js viewer (has a visible Find box). Fallback to native viewer if not available.
  const [usePdfJs, setUsePdfJs] = useState(true);
  const viewerBase = "/pdfjs/web/viewer.html"; // place PDF.js assets here (public/pdfjs/web/*)
