    ...
    <div className="workbench">
      ...
      <section className="wb-left">
        ...
        <div className="wb-pdf-wrap">
          {viewerSrc ? (
            <iframe
              ...
              src={viewerSrc}
              // allow transparency for dark toolbar shadows, etc.
        ...
        <div className="wb-hint">
          The viewer has a built-in **Find**. When you click a clause in the answer, we
          auto-fill the search box in the viewer.
        </div>
      </section>
