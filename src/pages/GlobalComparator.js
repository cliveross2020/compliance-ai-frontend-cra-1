...
/** Highlight matching topic in text */
...
const GlobalComparator = () => {
  ...
  const [expanded, setExpanded] = useState({}); // track expanded state per snippet
  ...
  /** Toggle expand for a specific snippet */
  const toggleExpand = (country, index) => {
  ...
  /** Truncate paragraph to preview length */
    ...
    <div className="gc-layout">
      ...
      <div className="gc-form">
        <div className="gc-logo-wrap">
          <img src={caiLogo} alt="Compliance AI" className="gc-logo" />
        </div>
                      ...
                      return (
                        ...
                        >
                          {isOpen
                            ...
                            : highlight(truncate(m), topic.trim())}
                          {!isOpen && m.length > 200 && (
